...
l=new JLabel();
icon=new ImageIcon("src/images/background3.jpg");  //在此直接创建对象,注意目录之间的分隔符是双斜线
l.setIcon(icon);
...
this.pack(); 
		...
		*/
		...
		lblNl.setFont(new Font("华文中宋", Font.PLAIN, 32));
	}
...
*/
	...
	private void openmenu_2(JMenu menu_2) {
		menu_2.addItemListener(new ItemListener() {    //监听器，接受按钮所做的活动
			public void itemStateChanged(ItemEvent e) {
				if(menu_2.isSelected()){
		System.out.println("menu_2按钮被点击了");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    	setVisible(false);//窗口关闭
    	new LogOnFrm().setVisible(true);}//窗口打开
			}
    	});
	}

...
public class BookManageMain extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookManageMain frame = new BookManageMain();
...
while(keys.hasMoreElements()) {
	...
	if(value instanceof javax.swing.plaf.FontUIResource) {
		...
		btnNewButton.setIcon(new ImageIcon(BookManageMain.class.getResource("/images/return1.png")));
		...
		JButton btnNewButton_1 = new JButton("图书增添");
		btnNewButton_1.setIcon(new ImageIcon(BookManageMain.class.getResource("/images/add2.png")));
		...
		btnNewButton_1.addActionListener(new ActionListener() {
	        public void actionPerformed(ActionEvent e) {
	        	...
	        	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	        	setVisible(false);
	        	new BooksAdd().main(null);;
	        }
	        });
		
		JButton btnNewButton_2 = new JButton("图书移除");
		btnNewButton_2.setIcon(new ImageIcon(BookManageMain.class.getResource("/images/down2.png")));
		...
		label.setIcon(new ImageIcon(BookManageMain.class.getResource("/images/human2.png")));
